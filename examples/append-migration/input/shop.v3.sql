...
--
-- Name: product_reviews; Type: TABLE; Schema: shop; Owner: -
--
...
--
-- Name: TABLE product_reviews; Type: COMMENT; Schema: shop; Owner: -
--

COMMENT ON TABLE shop.product_reviews IS 'Customer product reviews, 1-5 stars.';

--
-- Name: coupons; Type: TABLE; Schema: shop; Owner: -
--
...
--
-- Name: TABLE coupons; Type: COMMENT; Schema: shop; Owner: -
--
...
ALTER TABLE shop.orders
    ADD CONSTRAINT orders_status_check CHECK (status IN ('pending', 'paid', 'shipped', 'cancelled', 'refunded'));
...
--
-- Name: product_reviews product_reviews_pkey; Type: CONSTRAINT; Schema: shop; Owner: -
--
...
--
-- Name: coupons coupons_pkey; Type: CONSTRAINT; Schema: shop; Owner: -
--
...
--
-- Name: product_reviews product_reviews_rating_check; Type: CHECK CONSTRAINT; Schema: shop; Owner: -
--

ALTER TABLE shop.product_reviews
    ADD CONSTRAINT product_reviews_rating_check CHECK (rating >= 1 AND rating <= 5);
...
--
-- Name: product_reviews product_reviews_product_id_fkey; Type: FK CONSTRAINT; Schema: shop; Owner: -
--
...
--
-- Name: product_reviews product_reviews_customer_id_fkey; Type: FK CONSTRAINT; Schema: shop; Owner: -
--

ALTER TABLE ONLY shop.product_reviews
    ADD CONSTRAINT product_reviews_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES shop.customers(id);
...
--
-- Name: idx_product_reviews_product_id; Type: INDEX; Schema: shop; Owner: -
--

CREATE INDEX idx_product_reviews_product_id ON shop.product_reviews USING btree (product_id);
...
--
-- Name: orders orders_insert_own; Type: POLICY; Schema: shop; Owner: -
--

CREATE POLICY orders_insert_own ON shop.orders
    FOR INSERT
...
--
-- Name: TABLE product_reviews; Type: ACL; Schema: shop; Owner: -
--

GRANT SELECT, INSERT ON TABLE shop.product_reviews TO app_user;
